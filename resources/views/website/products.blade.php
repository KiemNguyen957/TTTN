	...
	<div class="container">
		<div class="row" style=" padding-top: 50px;">
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
				<div class="product-single-sidebar">
					...
					<ul class="">
						...
						@foreach($catelogs as $category)

						<li>
							<a @if(isset($cat)&&$cat->id==$category->id){{'style=color:red'}}@endif href="{{route('web.catelogs',$category->slug)}}">{{$category->name}}</a>
						</li>
						@endforeach
					</ul>
				</div>
			...
			<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
				...
				<div class="all-gategory-product">
					<div class="row">
						<ul class="gategory-product">
							...
							@endif 
							@if(isset($allproduct)) @foreach($allproduct as $product)
				...
				{{$allproduct->links()}} @endif
				<div class="all-gategory-product">
					<div class="row">
						<ul class="gategory-product">
							@if(isset($listproduct)) @foreach($listproduct as $product)
							<li class="gategory-product-list col-lg-4 col-md-4 col-sm-6 col-xs-12" style="padding-right: 50px;">
								<div class="single-product-item">
									<div class="product-image">
										<a href="{{route('web.product.single',$product->slug)}}">
