          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <div class="col-md-12"><h4 class="col-md-6"><i class="fa fa-angle-right"></i> Danh sách sản phẩm </h4>
                <a href="{{route('products.create')}}" class="btn btn-theme03 pull-right">+Thêm sản phẩm</a></div>
                <hr>
                <thead>
                  <tr>
                    <th>STT</th>
