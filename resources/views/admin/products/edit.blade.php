              ...
              {{method_field('PUT')}}
                <div class="col-md-6  centered" style="padding-top: 55px;">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8">
                          <input type="" placeholder=" " name="name" class="form-control" value="{{$product->name}}">
                      </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-lg-8" style="text-align: left">
                        <div class="btn-group">
                          <input type="" placeholder=" " name="price" class="btn col-lg-5" value="{{$product->price}}" style="cursor: auto;text-align: left;color: #333;background-color: #fff;border-color: #ccc;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-8" style="text-align: left">
                        <div class="btn-group">
                          <input type="" placeholder=" " name="sale" class="btn col-lg-5" value="{{$product->sale}}" style="cursor: auto;text-align: left;color: #333;background-color: #fff;border-color: #ccc;">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-lg-8">
                        <textarea class="form-control" name="promotion" id="contact-message" placeholder="Your Message" rows="3" data-rule="required" data-msg="Please write something for us">{{$product->promotion}}</textarea>
                          ...
                          <div class="col-lg-8 col-lg-offset-1 detailed">
                            <h4 class="mb">Thông số kỹ thuật</h4>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-9">  
                                  <input type="text" placeholder=" " name="screen" class="form-control" value="{{$product->screen}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-3 control-label">Hệ điều hành</label>
                                  <div class="col-lg-9">
                                  <input type="text" placeholder=" " name="operating_system" class="form-control" value="{{$product->operating_system}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-3 control-label">Camera</label>
                                  <div class="col-lg-9">
                                  <input type="text" placeholder=" " name="camera" class="form-control" value="{{$product->camera}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-3 control-label">CPU</label>
                                  <div class="col-lg-9">
                                      <input type="text" placeholder=" " name="cpu" class="form-control" value="{{$product->cpu}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-3 control-label">RAM</label>
                                  <div class="col-lg-9">
                                      <input type="text" placeholder=" " name="ram" class="form-control" value="{{$product->ram}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-3 control-label">Bộ nhớ trong</label>
                                  <div class="col-lg-9">
                                      <input type="text" placeholder=" " name="memory" class="form-control" value="{{$product->memory}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-3 control-label">Thẻ nhớ</label>
                                  <div class="col-lg-9">
                                      <input type="text" placeholder=" " name="memory_card" class="form-control" value="{{$product->memory_card}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-lg-3 control-label">Dung lượng pin</label>
                                  <div class="col-lg-9">
                                      <input type="text" placeholder=" " name="pin" class="form-control" value="{{$product->pin}}">
                                  </div>
                              </div>
                            <div class="form-group">
